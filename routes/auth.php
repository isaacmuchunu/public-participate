...
Route::middleware('guest')->group(function () {
    ...
    Route::get('register/verify', [RegistrationOtpController::class, 'create'])
        ->name('register.verify');

    Route::post('register/verify', [RegistrationOtpController::class, 'store'])
    ...
    Route::get('invitation/{token}', [InvitationAcceptanceController::class, 'show'])
