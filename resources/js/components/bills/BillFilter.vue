    ...
    <Card>
            ...
            <div class="flex items-center justify-between">
                <CardTitle class="flex items-center gap-2">
                    ...
                    <span
                        ...
                        class="bg-primary text-primary-foreground flex h-5 w-5 items-center justify-center rounded-full text-xs font-bold"
                    >
                        {{ getActiveFilterCount() }}
                    </span>
                </CardTitle>
                <Button v-if="getActiveFilterCount() > 0" variant="ghost" size="sm" @click="clearAllFilters"> Clear All </Button>
            </div>
        </CardHeader>
        ...
        <CardContent class="space-y-6">
            ...
            <div class="space-y-3">
                ...
                <div class="space-y-2">
                    <div v-for="option in houseOptions" :key="option.value" class="flex items-center gap-2">
                        <Checkbox
