    ...
    <AppLayout>
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-muted-foreground">Browse and participate in legislative bills open for public comment</p>
            </div>

            <div class="grid gap-6 lg:grid-cols-[300px_1fr]">
                <!-- Sidebar: Filters -->
                <aside class="space-y-6">
                    <BillFilter v-model="filters" @update:model-value="handleFilterChange" />
                </aside>
                ...
                <main class="space-y-6">
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex-1">
                            <BillSearch v-model="searchQuery" @search="handleSearch" />
                        </div>
                    ...
                    <!-- Results Count -->
                    <div v-if="bills.data.length > 0" class="text-muted-foreground text-sm" role="status" aria-live="polite">
                    ...
                    <!-- Bills Grid/List -->
                    <div v-else-if="bills.data.length > 0" :class="[viewMode === 'grid' ? 'grid gap-6 sm:grid-cols-2 xl:grid-cols-3' : 'space-y-4']">
                    ...
                    <!-- Pagination -->
                    <div v-if="bills.last_page > 1" class="flex items-center justify-center gap-2">
                        <Button
                            variant="outline"
                            size="sm"
                        ...
                        <span class="text-muted-foreground text-sm"> Page {{ bills.current_page }} of {{ bills.last_page }} </span>
